...
`[1.1]` *Stadion-Atmosphäre vom Band. Die fünf Spieler:innen kommen
einzeln oder in Grüppchen herein, jede/r in einem Fussball-Nationaltrikot.*

`[1.2]` *Noah macht demonstrativ Liegestütze am Bühnenrand.*

`[1.3]` *Ueli jongliert konzentriert mit einem Fussball.*

`[1.4]` *Matthias und Susanne spielen sich einen Ball zu.*

`[1.5]` *Stefanie macht übertriebene Dehnübungen (Ausfallschritte,
Armkreisen).*
...
`[3.1]` **[ANDREAS]** *(blättert in seinem Klemmbrett)*
"Bevor wir loslegen: Hat noch jemand seine **Sammelbildchen** dabei?
...
Die Daniela fehlt mir!"

`[3.4]` **[NOAH]**
"Nein, die Daniela habe ich auch nicht. Aber ich habe die
**Annina** doppelt. Hast du den **Benjamin**? Ich gebe dir die
Annina, wenn du mir den Benjamin gibst."

`[3.5]` **[UELI]** *(verzweifelt)*
"Mir fehlt die **Elisabeth** — wer hat die Elisabeth?"

`[3.6]` **[MATTHIAS]** *(grosszügig)*
"Ich habe sie gleich **vier Mal** — du kannst sie haben, ich
schenke sie dir."

`[3.7]` **[STEFANIE]** *(blättert eifrig)*
"Ich brauche noch die **Doris** — das ist eine **glänzende** —
wer hat die?"

`[3.8]` **[SUSANNE]** *(geschäftstüchtig)*
"Ich. Aber dann musst du mir zwei andere dafür geben."

`[3.9]` **[STEFANIE]**
"Okay — du kannst den **Thomas** und den **Leo** haben."

`[3.10]` **[NOAH]** *(seufzt)*
"Den Leo hast du sicher mehrfach, gell — der ist ja in
**Argentinien**…"

`[3.11]` *Alle lachen kurz.*

---

## Szene 4 — Aufstellung & Refrain (≈ 3 Min)

`[4.1]` **[ANDREAS]** *(pfeift laut)*
"Genug getauscht! **Aufstellen, bitte!**"

`[4.2]` *Die fünf Spieler:innen stellen sich kreuz und quer auf.*

`[4.3]` **[ANDREAS]**
"Was soll das?! **Der Grösse nach**, bitte!"

`[4.4]` *Sie sortieren sich hektisch.*
...
`[4.12]` **[ANDREAS]** *"Wer fehlt noch?"*
`[4.13]` **[ALLE SPIELER]** *(im Chor, Finger hoch)* *"Einer fehlt noch!"*
...
> 🔁 **REFRAIN #2** *(Publikum kommt evtl. langsam mit)*

`[4.18]` **[ANDREAS]** *"Wer fehlt noch?"*
`[4.19]` **[ALLE SPIELER]** *"Einer fehlt noch!"*
...
`[4.23]` **[ANDREAS]** *(pfeift, schaut frech ins Publikum, winkt)*
"Der Grösse nach! Und jetzt alle mit!"

> 🔁 **REFRAIN #3** *(Publikum macht mit!)*

`[4.24]` **[ANDREAS]** *"Wer fehlt noch?"*
`[4.25]` **[ALLE SPIELER + PUBLIKUM]** *"Einer fehlt noch!"*
...
`[4.29]` **[ANDREAS]** *(grinst, das Spiel ist gestartet)*

> 🔁 **REFRAIN #4** *(Publikum voll dabei)*

`[4.30]` **[ANDREAS]** *"Wer fehlt noch?"*
`[4.31]` **[ALLE + PUBLIKUM]** *"Einer fehlt noch!"*

`[4.32]` **[UELI]**
"Der **Leo**! Der ist in **Argentinien**, in einem **Trainingslager
bei Messi**…"
...
## Szene 6 — Die Befragung von David (≈ 1.5 Min)

`[6.1]` **[ANDREAS]** *(streng, mit Klemmbrett)*
"**Frage eins:** Kannst du **Fussball spielen**?"

`[6.2]` **[DAVID]** *(antwortet — wir hoffen "Ja!")*

`[6.3]` **[SUSANNE]**
"**Frage zwei:** Warst du schon einmal auf dem **Känzeli in Bad
Reuthe**?" `[?]`

`[6.4]` **[STEFANIE]**
"**Frage drei:** Spielst du gerne **Krimi-Dinner**?" `[?]`
